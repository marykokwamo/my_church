...
void setDarkModeSetting(BuildContext context, ThemeMode themeMode) {
  // Update theme using the Theme.of(context) instead
  if (context.mounted) {
    // Theme switching can be implemented here if needed
  }
}
...
extension MapListContainsExt on List<dynamic> {
  bool containsMap(dynamic map) {
    return map is Map &&
        (this is Map
            ? const DeepCollectionEquality().equals(this, map)
            : any((e) =>
...
String getCurrentRoute(BuildContext context) =>
    context.mounted ? ModalRoute.of(context)?.settings.name ?? '' : '';
