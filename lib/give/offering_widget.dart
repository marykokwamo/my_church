...
class OfferingWidget extends StatefulWidget {
  const OfferingWidget({Key? key}) : super(key: key);

  @override
  _OfferingWidgetState createState() => _OfferingWidgetState();
}

class _OfferingWidgetState extends State<OfferingWidget> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Your offering of KES ${_amountController.text} has been received.',
                  textAlign: TextAlign.center,
                  style: GoogleFonts.poppins(
                    fontSize: 14,
                    color: Colors.black54,
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text(
                      'Enter the amount you wish to give as an offering. You will receive a request to enter your Mpesa pin shortly.',
                      style: GoogleFonts.poppins(
                        fontSize: 14,
                        color: Colors.black54,
                      ),
