...
export 'join_request_model.dart';
...
class _JoinRequestWidgetState extends State<JoinRequestWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JoinRequestModel());
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          30.0, 0.0, 30.0, 0.0),
                                      child: Text(
                                        'Enter your mobile number and pick \na church to get started.',
                                        textAlign: TextAlign.start,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                  ...
                                  FlutterFlowDropDown<String>(
                                    ...
                                    elevation: 2.0,
                                    borderColor: const Color(0x00D0D0D0),
                                    borderWidth: 1.0,
                                    borderRadius: 8.0,
